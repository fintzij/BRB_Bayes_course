...
This lecture also borrowed material from Vladimir Minin's
\href{http://vnminin.github.io/SISMID_MCMC_I/}{MCMC for infectious
diseases} short course, and from Aki Vehtari's
\href{https://github.com/avehtari/BDA_course_Aalto}{Bayesian data
analysis} course. These are both fantastic resources and you should
check them out.
